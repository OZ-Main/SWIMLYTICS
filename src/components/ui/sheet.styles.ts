...
export const sheetContentVariants = cva(
  'fixed inset-y-0 left-0 z-50 flex h-full w-[min(20rem,92vw)] max-w-full flex-col border-r border-sidebar-border bg-sidebar text-sidebar-foreground shadow-overlay duration-motion-normal ease-motion-emphasized data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left',
)
